...
class Updater(object):
    ...
    def _attempt_to_update(self):
        ...
        logging.debug('[tldtosms.sync.check_if_update_available] Latest update were : %s' % self.last_modification_time)
        ...
        if self.last_modification_time < self.minimum_update_interval:
            ...
            local_diff_file = open(self.tld_diff_file, "r+w")
            local_data_file = open(self.tld_data_file, "r+w")
